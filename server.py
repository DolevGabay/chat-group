...
def remove_port_endpoint(port):
    ...
    # Add logic to stop/close the WebSocket server associated with the given port
    # You may want to implement a method in WebSocketServer to gracefully stop the server
